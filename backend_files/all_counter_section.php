    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <td>
                    <a class="btn btn-primary" style="font-size:smaller" href="../controller/counter_status.php?id=<?= $result['id'] ?>"><?= $result['status'] != 0 ? "De-Active" : "Active" ?></a></a>
                    <a class="btn btn-danger deletebanner" style="font-size:smaller" href="../controller/delete_counter.php?id=<?= $result['id'] ?>">Delete</a></a>
                </td>
            </tr>
