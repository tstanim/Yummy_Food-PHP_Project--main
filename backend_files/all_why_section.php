...
<table class="table">
    <thead>
        <tr>
            <th scope="col">#</th>
            <th scope="col">Why Card Description</th>
    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <td>
                    <a class="btn btn-primary" style="font-size:smaller" href="../controller/why_section_status.php?id=<?= $result['id'] ?>"><?= $result['status'] != 0 ? "De-Active" : "Active" ?></a></a>
                    <a class="btn btn-info" style="font-size:smaller;margin:5px 0px" href="./edit_why_section.php?id=<?= $result['id'] ?>">&nbsp;&nbsp;Edit&nbsp;&nbsp;</a></a>
                    <a class="btn btn-danger deletebanner" style="font-size:smaller" href="../controller/delete_why_section.php?id=<?= $result['id'] ?>">Delete</a></a>
                </td>
            </tr>
